...
public class CopyIntoMain {
	public static void main(String[] args) throws IOException {
		String dirSource = "./src/main/java/com/lam/coder/acmp/";
		String dirOut = "./src/main/java/";

		System.out
		.println("acmp.jp: Utility for creating the a Main.java Class -within the default package- from a given class.");
		...
		try {
			outputStream = new PrintWriter(new FileWriter(dirOut + "Main.java"));
