package com.lam.coder.acmp.dataLoad;
...
public class CreateTestClassFromTemplate {
	public static void main(String[] args) throws IOException {
		...
		System.out
		.println("acmp.ru: Utility for creating the Test Class.");
		System.out
		...
		sc.close();
		String sourceFile = "src/test/java/com/lam/coder/acmp/MainTest.java";
		String outputDir = "src/test/java/com/lam/coder/acmp";
		String packageTest = "package com.lam.coder.acmp;" + System.getProperty("line.separator");
		Scanner s = null;
