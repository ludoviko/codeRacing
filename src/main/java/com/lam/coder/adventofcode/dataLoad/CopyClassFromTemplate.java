...
public class CopyClassFromTemplate {
    public static void main(String[] args) throws IOException {
        String dirIn = "src/main/java/com/lam/coder/adventofcode/";
        String dirOut = "src/main/java/com/lam/coder/adventofcode/";
        System.out
                .println("AdventOfCode.com: Utility for creating the Given Class from a Main Class Template.");
