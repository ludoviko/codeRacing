package com.lam.coder.adventofcode.dataLoad;
...
public class CopyTestClassFromTemplate {
    public static void main(String[] args) throws IOException {
        System.out
                .println("Advent Of Code: Utility for creating the Test Class.");
        System.out
        ...
        String sourceFile = "src/test/java/com/lam/coder/adventofcode/MainTest.java";
        String outputDir = "src/test/java/com/lam/coder/adventofcode/";
        String packageTest = "package com.lam.coder.adventofcode;" + System.getProperty("line.separator");
        Scanner s = null;
