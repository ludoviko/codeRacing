...
public class CopyIntoMain {
	public static void main(String[] args) throws IOException {
		String dirSource = "./src/main/java/com/lam/coder/atCoder/";
		String dirOut = "./src/main/java/";

		System.out
		.println("atcoder.jp: Utility for creating the a Main.java Class -within the default package- from a given class.");
