...
public class CreateTestClassFromTemplate {
	public static void main(String[] args) throws IOException {
		...
		System.out
		.println("atCoder.jp: Utility for creating the Test Class.");
		System.out
		...
		sc.close();
		String sourceFile = "src/test/java/com/lam/coder/atCoder/MainTest.java";
		String outputDir = "src/test/java/com/lam/coder/atCoder/";
		String packageTest = "package com.lam.coder.atCoder;" + System.getProperty("line.separator");
		Scanner s = null;
