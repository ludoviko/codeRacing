 ...
 *         <p>
 *         Problem: SALARY     Easy          The Minimum Number Of Moves.
 */

public class TheMinimumNumberOfMoves {
    public TheMinimumNumberOfMoves() {
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        TheMinimumNumberOfMoves main = new TheMinimumNumberOfMoves();
        ...
        for (int i = 0; i < n; i++) {
            len = scanner.nextInt();
            int[] array = scanner.nextIntArray(len);
