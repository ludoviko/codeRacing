...
public class CopyTestClassFromTemplate {
    public static void main(String[] args) throws IOException {
        System.out
                .println("Code Chef: Utility for creating the Test Class.");
        System.out
        ...
        String sourceFile = "src/test/java/com/lam/coder/codeChef/MainTest.java";
        String outputDir = "src/test/java/com/lam/coder/codeChef/";
        String packageTest = "package com.lam.coder.codechef;" + System.getProperty("line.separator");
        Scanner s = null;
