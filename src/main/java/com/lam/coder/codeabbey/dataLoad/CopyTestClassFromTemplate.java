...
public class CopyTestClassFromTemplate {
	public static void main(String[] args) throws IOException {
		System.out
		.println("Code Abbey: Utility for creating the Test Class.");
		System.out
		...
		String sourceFile = "src/test/java/com/lam/coder/codeabbey/MainTest.java";
		String outputDir = "src/test/java/com/lam/coder/codeabbey/";
		String packageTest = "package com.lam.coder.codeabbey;" + System.getProperty("line.separator");
		Scanner s = null;
