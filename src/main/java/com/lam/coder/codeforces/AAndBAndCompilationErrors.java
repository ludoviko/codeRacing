 ...
 *
 * CF Problem: 519B	 #294 Div-2  A And B And Compilation Errors.
 *
 */
...
public class AAndBAndCompilationErrors {
    ...
    public  AAndBAndCompilationErrors() {
    }
	...
	public static void main(String[] args) throws IOException {
        ...
        int[] data2 = scanner.nextIntArray(--n);
        int[] data3 = scanner.nextIntArray(--n);
