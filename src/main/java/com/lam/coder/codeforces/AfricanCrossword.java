 ...
 *         <p>
 *         Problem: 90B Beta #74 Div-2            African Crossword.
 */

public class AfricanCrossword {
    char[][] data;

    public AfricanCrossword(char[][] data) {
        this.data = data;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < rows; i++) {
            strings[i] = scanner.nextString();
            data[i] = strings[i].toCharArray();
        }

        AfricanCrossword africanCrossword = new AfricanCrossword(data);

        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < columns; c++) {
                if (africanCrossword.isLetterOnce(r, c)) {
                    solution += data[r][c];
                }
            }
        }
    ...
    public boolean isLetterOnce(int row, int column) {
        int counterRow = 0;
        int counterColumn = 0;
        ...
        return counterRow < 2 && counterColumn < 2;
    }
