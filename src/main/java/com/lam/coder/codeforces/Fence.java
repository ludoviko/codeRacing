 ...
 *
 * CF Problem: 363B  #211 Div-2 Fence.
 *
 */
...
public class Fence {
	...
	public static void main(String[] args) throws IOException {
        ...
        int[] sequence = scanner.nextIntArray(data[0]);
        ...
        for (int i = 1; i < sequence.length - (data[1] - 1); i++) {
            sum = sum - sequence[i-1] + sequence[i-1+data[1]];
            if (sum < min) {
                min = sum;
                index = i;
            }
