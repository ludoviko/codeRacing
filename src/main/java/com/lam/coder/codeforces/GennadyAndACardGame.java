 ...
 * <p>
 * CF Problem: 1097A   Hello 2019   Gennady and a Card Game.
 */
...
public class GennadyAndACardGame {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String card = scanner.nextString();
        ...
        for (String myCard : cards) {
            if (myCard.charAt(0) == card.charAt(0) || myCard.charAt(1) == card.charAt(1)) {
                any = true;
                break;
            }
        }
