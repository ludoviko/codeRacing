 ...
 *         <p>
 *         Problem: 258A  #157 Div-1		          Little Elephant and Bits.
 */

public class LittleElephantAndBits {
    public LittleElephantAndBits() {
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < string.length() && j < data.length; i++) {
            if (string.charAt(i) == '0' && !zeroDeleted) {
                zeroDeleted = true;
            } else {
