 ...
 *         <p>
 *         Problem: 276B  #169 Div-2   Little Girl and Game.
 */

public class LittleGirlAndGame {
    private String string;

    public LittleGirlAndGame(String string) {
        this.string = string;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        LittleGirlAndGame game = new LittleGirlAndGame(string);
        int odds = game.countOdds();
