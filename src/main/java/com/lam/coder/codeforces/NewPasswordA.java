 ...
 *
 * Problem:   770A  VK Cup 2017 Q-2  New Password.
 *
 *
 */

public class NewPasswordA {
    ...
    public  NewPasswordA(int len, int n) {
        this.len = len;
        this.n = n;
    }
    ...
    public String find() {
        ...
        Character[] letters = set.toArray(new Character[] {});
	...
	public static void main(String[] args) throws IOException {
		...
		NewPasswordA main = new NewPasswordA(data[0], data[1]);
