 ...
 *
 * CF Problem: 1154 @552 Div-3 Restoring Three Numbers.
 *
 */
...
public class RestoringThreeNumbers {
	...
	public static void main(String[] args) throws IOException {
        ...
        Arrays.sort(data);
        int a = data[0] + data[1] - data[3];
        int b = data[1] + data[2] - data[3];
        int c = data[0] + data[2] - data[3];
