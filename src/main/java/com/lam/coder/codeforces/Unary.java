 ...
 *         <p>
 *         Problem:   133B  Beta #96 Div-2           Unary     .
 */
public class Unary {
    public Unary() {
    }
    ...
    public static String translate(String string) {
        ...
        BigInteger bigInteger = new BigInteger(builder.toString(), 2).mod(new BigInteger(Integer.toString(1000003)));
