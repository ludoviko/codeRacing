 ...
 * 
 *         This is a demo task. You can read about this task and its solutions
 *         in this http://blog.codility.com/2011/03/solutions-for-task-equi.html
 *         post.
 * 
 ...
 * 
 *         P = 7 is not an equilibrium index, because it does not fulfill the
 *         condition 0 ≤ P < N.
 * 
 *         Write a function
 * 
 ...
 *         Assume that:
 * 
 *         N is an integer within the range [0..10,000,000]; each element of
 *         array A is an integer within the range
 *         [−2,147,483,648..2,147,483,647].
 * 
 *         Score: No own score.
 *         
 *         Right solution copy from codility.
 */
...
public class ArrayEquilibrium {
	...
	public static void main(String[] args) {
		ArrayEquilibrium equi = new ArrayEquilibrium();
		int n = equi.solution(-7, 1, 5, 2, -4, 3, 0);
		System.out.println(n + "/ 3,6");
		n = equi.solution(4, 3, 4);
