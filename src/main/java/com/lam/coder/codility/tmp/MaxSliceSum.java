 ...
 * 
 *         1. MaxSliceSum Find a maximum sum of a compact subsequence of array
 *         elements.
 * 
 ...
 *         of array A. The sum of a slice (P, Q) is the total of A[P] + A[P+1] +
 *         ... + A[Q].
 * 
 *         Write a function:
 * 
...
public class MaxSliceSum {
	public int solution(int... array) {
		int maxEnding, maxSlice;
		maxEnding = 0;
		maxSlice = Integer.MIN_VALUE;
		for (int a : array) {
