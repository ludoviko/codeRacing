...
public class CopyClassFromTemplate {
	public static void main(String[] args) throws IOException {
		String dirIn = "src/main/java/com/lam/coder/cses/";
		String dirOut = "src/main/java/com/lam/coder/cses/";
		System.out
		.println("CSES.fi: Utility for creating the Given Class from a Main Class Template.");
