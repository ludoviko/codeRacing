package com.lam.coder.cses.dataLoad;
...
public class CopyTestClassFromTemplate {
	public static void main(String[] args) throws IOException {
		System.out
		.println("Cses.fi: Utility for creating the Test Class.");
		System.out
		...
		String sourceFile = "src/test/java/com/lam/coder/cses/MainTest.java";
		String outputDir = "src/test/java/com/lam/coder/cses/";
		String packageTest = "package com.lam.coder.cses;" + System.getProperty("line.separator");
		Scanner s = null;
