package com.lam.coder.dmoj.dataLoad;
...
public class CopyClassFromTemplate {
    public static void main(String[] args) throws IOException {
        String dirIn = "src/main/java/com/lam/coder/dmoj/";
        String dirOut = "src/main/java/com/lam/coder/dmoj/";
        System.out
                .println("dmoj: Utility for creating the Given Class from a Main Class Template.");
