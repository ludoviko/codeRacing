...
public class CopyTestClassFromTemplate {
    public static void main(String[] args) throws IOException {
        System.out
                .println("dmoj: Utility for creating the Test Class.");
        System.out
        ...
        String sourceFile = "src/test/java/com/lam/coder/dmoj/MainTest.java";
        String outputDir = "src/test/java/com/lam/coder/dmoj/";
