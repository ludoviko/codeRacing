package com.lam.coder.geeksforgeeks;
...
public class KthSmallestFactor {
    ...
    public KthSmallestFactor(long n) {
        this.n = n;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            data = scanner.nextLongArray(2);
            main = new KthSmallestFactor(data[0]);
            main.findFactors();
            int k = (int) data[1];

            out.println(k > main.getList().size() ? -1 : main.getList().get(k - 1));
        }
