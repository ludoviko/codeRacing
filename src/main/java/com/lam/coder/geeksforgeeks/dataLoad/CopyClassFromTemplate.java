package com.lam.coder.geeksforgeeks.dataLoad;
...
public class CopyClassFromTemplate {
    public static void main(String[] args) throws IOException {
        String dirIn = "src/main/java/com/lam/coder/geeksforgeeks/";
        String dirOut = "src/main/java/com/lam/coder/geeksforgeeks/";
        System.out
                .println("Geeks for Geeks: Utility for creating the Given Class from a Main Class Template.");
