...
public class PrimeNumberUpTo {
    ...
    // One base array, kind of.
    private boolean[] data;

    public PrimeNumberUpTo(int size) {
        this.data = new boolean[size + 1];
    ...
    public void setData() {
        int upTo = (int) Math.sqrt(this.data.length);
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrimeNumberUpTo main = new PrimeNumberUpTo(n);
        main.setData();
        main.printPrimes();
