...
public class CopyTestClassFromTemplate {
    public static void main(String[] args) throws IOException {
        System.out
                .println("hackerearth: Utility for creating the Test Class.");
        System.out
        ...
        String sourceFile = "src/test/java/com/lam/coder/hackerearth/MainTest.java";
        String outputDir = "src/test/java/com/lam/coder/hackerearth/";
        String packageTest = "package com.lam.coder.hackerearth;" + System.getProperty("line.separator");
        Scanner s = null;
