package com.lam.coder.programmingpraxis.dataLoad;
...
public class CopyClassFromTemplate {
    public static void main(String[] args) throws IOException {
        String dirIn = "src/main/java/com/lam/coder/programmingpraxis/";
        String dirOut = "src/main/java/com/lam/coder/programmingpraxis/";
        System.out
                .println("programmingpraxis: Utility for creating the Given Class from a Main Class Template.");
