 ...
 *         Square P4,n=n2 1, 4, 9, 16, 25, ... Pentagonal P5,n=n(3n−1)/2 1, 5,
 *         12, 22, 35, ... Hexagonal P6,n=n(2n−1) 1, 6, 15, 28, 45, ...
 ...
 *         the first). Each polygonal type: triangle (P3,127=8128), square
...
public class CyclicalFigurateNumbers {
	...
	private static boolean isSquare(long n) {
		...
		square = (1 + Math.sqrt(1 + 24 * n)) / 6;
		squareInt = Math.floor(square);
