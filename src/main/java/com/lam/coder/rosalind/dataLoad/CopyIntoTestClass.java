package com.lam.coder.rosalind.dataLoad;
...
public class CopyIntoTestClass {
	public static void main(String[] args) throws IOException {
		...
		System.out
		.println("Enter arg: the name of the target test class, NextRound or what ever, white spaces will be trimmed: ");
		...
		String sourceFile = "source/com/lam/coder/rosalind/test/MainTest.java"; 
		String outputDir = "source/com/lam/coder/rosalind/test/"; 
		String packageTest = "package com.lam.coder.rosalind.test;" + System.getProperty("line.separator");
		Scanner s = null;
