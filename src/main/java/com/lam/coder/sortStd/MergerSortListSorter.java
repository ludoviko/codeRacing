 ...
 *         Definition
 * 
 *         Class: MergerSort Method: howManyComparisons Parameters: int[]
...
public class MergerSortListSorter<T> implements ListSorter<T> {
	...
	public MergerSortListSorter(Comparator<T> comparator) {
		this.comparator = comparator;

	}

	public MergerSortListSorter() {
	...
	// A simpler implementation than merge2. 
