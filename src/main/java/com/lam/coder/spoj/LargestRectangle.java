 ...
 * <p>
 * Spoj problem: HISTOGRA   Largest Rectangle in a Histogram.
 */
...
public class LargestRectangle {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (n != 0) {
            int i = 0;
            long[] data = scanner.nextLongArray(n);
                ...
                if (i == 0) {
                    ...
                    if (data[i] >= data[stack.peek()]) {
                        ...
                        while (!stack.isEmpty() && data[i] < data[stack.peek()]) {
                            ...
                            //  Calculate area
                            if (stack.isEmpty()) {
                                area =  data[popIndex] * i;
                            } else {
                                area =  data[popIndex] * (i - 1 - stack.peek());
                            }
                            if (area > max) {
                                max = area;
                            }
