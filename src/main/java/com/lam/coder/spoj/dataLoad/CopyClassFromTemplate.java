package com.lam.coder.spoj.dataLoad;
...
public class CopyClassFromTemplate {
    public static void main(String[] args) throws IOException {
        String dirIn = "src/main/java/com/lam/coder/spoj/";
        String dirOut = "src/main/java/com/lam/coder/spoj/";
        System.out
                .println("Sphere Online Judge: Utility for creating the Given Class from a Main Class Template.");
