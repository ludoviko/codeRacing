package com.lam.coder.urioj.dataLoad;
...
public class CopyIntoTestClass {
	public static void main(String[] args) throws IOException {
		...
		System.out
		.println("Enter arg: the name of the class, NextRound or what ever, white spaces will be trimmed: ");
		...
		String sourceFile = "source/com/lam/coder/urioj/test/MainTest.java";
		String outputDir = "source/com/lam/coder/urioj/test/";
		String packageTest = "package com.lam.coder.urioj.test;" + System.getProperty("line.separator");
		Scanner s = null;
