...
public class CopyIntoFile {
	public static void main(String[] args) throws IOException {
		String dirSource = "./src/main/java/com/lam/coder/usaco/";
		String dirOut = "./src/main/java/";

		System.out
		.println("Usaco: Utility for creating the a GivenClass.java Class -within the default package- from a given class.");
